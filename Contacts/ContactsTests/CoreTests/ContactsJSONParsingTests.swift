...
class ContactsJSONParsingTests: XCTestCase {
    
    private let contact = Contacts.testDataFromJSON().users[0]
    private let contactWithOptionals = Contacts.testDataFromJSON().users[1]
